...
public class FortuneList {
    ...
    public static String textFortune;
    public static String[] fortuneList = {"There is a true and sincere friendship between you and your friends.",
...
"Hope for what you want, but work for the things you need.",
...
"You will be invited to an exciting event." };
    ...
    public static void findFortuneIndex(){
        Random random = new Random();
        index = random.nextInt(fortuneList.length);
        textFortune = fortuneList[index];
        System.out.println(fortuneList[index]);
    }
}
